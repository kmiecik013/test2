  ...
  return (
    <div className="card-container">
      ...
      <button className="more-info-button"
            ...
            key={props.id}
            id= {props.id}
            onClick= {handleClick} >More Infokddwnvfvfvdkkvfvfnkfnfeefekfeeffefefekmdeidieejdjwijkfmme felkeffkmefmefmefekmffefmekfnwinmedwdifneinkfeffefefffekfejfefeflcml</button>
       <ModalId2
